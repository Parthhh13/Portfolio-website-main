...
const Navbar = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-10 transition-all duration-300 ${isScrolled ? 'bg-white shadow py-3' : 'bg-transparent py-5'}`}>
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <a href="#about" className="text-portfolio-darkGray hover:text-portfolio-blue font-medium transition-colors">About</a>
            <a href="#experience" className="text-portfolio-darkGray hover:text-portfolio-blue font-medium transition-colors">Experience</a>
            <a href="#projects" className="text-portfolio-darkGray hover:text-portfolio-blue font-medium transition-colors">Projects</a>
            <a href="#education" className="text-portfolio-darkGray hover:text-portfolio-blue font-medium transition-colors">Education</a>
            <a href="#skills" className="text-portfolio-darkGray hover:text-portfolio-blue font-medium transition-colors">Skills</a>
            <a href="#contact" className="text-portfolio-darkGray hover:text-portfolio-blue font-medium transition-colors">Contact</a>
